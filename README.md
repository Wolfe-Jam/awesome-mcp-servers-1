...
- <img src="https://raw.githubusercontent.com/Wolfe-Jam/claude-faf-mcp/main/assets/icons/faf-icon-48.png" height="14"/> [claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp) - First persistent project context MCP for Claude; the only one with an IANA-registered `.faf` format. Define your project once, every session starts grounded. Trophy scoring, SessionStart heartbeat, Glama AAA.
