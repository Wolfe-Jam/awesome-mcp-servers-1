...
- [FAF MCP Servers](https://github.com/Wolfe-Jam/claude-faf-mcp) - Persistent AI-context for any project via IANA-registered `.faf` format (`application/vnd.faf+yaml`). 33 tools. Available for [Claude](https://github.com/Wolfe-Jam/claude-faf-mcp), [Cursor/IDEs](https://github.com/Wolfe-Jam/faf-mcp), [Grok](https://github.com/Wolfe-Jam/grok-faf-mcp), [Gemini](https://github.com/Wolfe-Jam/gemini-faf-mcp), and [Rust](https://github.com/Wolfe-Jam/rust-faf-mcp).
