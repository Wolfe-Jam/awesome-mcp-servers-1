...
- <img src="https://raw.githubusercontent.com/Wolfe-Jam/faf-mcp/main/packages/faf-mcp/assets/icons/faf-icon-256.png" height="14"/> [faf-mcp](https://github.com/Wolfe-Jam/faf-mcp) - Universal persistent project context MCP server. IANA-registered .faf format (application/vnd.faf+yaml). 17 native tools for AI-readiness scoring, platform-aware bi-sync (creates .cursorrules, .clinerules, .windsurfrules, CLAUDE.md automatically). Works across Cursor, Windsurf, Cline, VS Code, and all MCP platforms. Published to GitHub MCP Registry.
