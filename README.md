...
- <img src="https://www.faf.one/orange-smiley.svg" height="14" /> [claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp)<sup><sup>⭐</sup></sup> - IANA-registered persistent AI context format (application/vnd.faf+yaml). 52 MCP tools for zero-drift project context with bi-directional sync, 6Ws Builder integration, and automatic README extraction. 21k+ downloads, 256 tests.
